...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            if(!char) return interaction.reply('**・Este personagem ou não existe ou não foi catalogado ainda!**\n┗ *Para mais detalhes, digite **/help build.***')
            
            let raridade = (char.raridade === 5) ? "<:raridade2:1015412419188768959><:raridade2:1015412419188768959><:raridade2:1015412419188768959><:raridade2:1015412419188768959><:raridade2:1015412419188768959>" : "<:raridade2:1015412419188768959><:raridade2:1015412419188768959><:raridade2:1015412419188768959><:raridade2:1015412419188768959>"  
            let BuildEmbed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Elemento', value: `${emotes[char.elemento.toLowerCase()]} ${char.elemento}`, inline: true },
            ...
            let ebd = {
              alterar: (msg) => {
                          BuildEmbed.setAuthor({ name: `${char.nome} ✦ ${char.extraBuilds[pagina].tipoDeBuild}` })
                          .setImage(char.extraBuilds[pagina].imagem)
                          msg.edit({ embeds: [BuildEmbed], fetchReply: true })
              },
              resetar: (msg) => {
                          BuildEmbed.setAuthor({ name: `${char.nome} ✦ ${char.tipoDeBuild}` })
                          .setImage(char.imagem)
                          msg.edit({ embeds: [BuildEmbed], fetchReply: true })
              }
            }
